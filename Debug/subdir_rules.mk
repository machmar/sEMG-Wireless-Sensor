...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/gcc_arm_none_eabi_9_2_1/bin/arm-none-eabi-gcc-9.2.1.exe" -c @"syscfg/device.opt"  -mcpu=cortex-m0plus -march=armv6-m -mthumb -mfloat-abi=soft -I"C:/Users/marec/workspace_ccstheia/EMG-BatchelorsThesis/sEMG-Wireless-Sensor" -I"C:/Users/marec/workspace_ccstheia/EMG-BatchelorsThesis/sEMG-Wireless-Sensor/Debug" -I"C:/ti/mspm0_sdk_2_04_00_06/source/third_party/CMSIS/Core/Include" -I"C:/ti/mspm0_sdk_2_04_00_06/source" -I"C:/ti/gcc_arm_none_eabi_9_2_1/arm-none-eabi/include/newlib-nano" -I"C:/ti/gcc_arm_none_eabi_9_2_1/arm-none-eabi/include" -O2 -ffunction-sections -fdata-sections -g -gdwarf-3 -gstrict-dwarf -Wall -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)" -I"C:/Users/marec/workspace_ccstheia/EMG-BatchelorsThesis/sEMG-Wireless-Sensor/Debug/syscfg" -std=c99 $(GEN_OPTS__FLAG) -o"$@" "$<"
...
build-1358088993: ../EMG-BatchelorsThesis.syscfg
	...
	"C:/ti/ccs2001/ccs/utils/sysconfig_1.22.0/sysconfig_cli.bat" --script "C:/Users/marec/workspace_ccstheia/EMG-BatchelorsThesis/sEMG-Wireless-Sensor/EMG-BatchelorsThesis.syscfg" -o "syscfg" -s "C:/ti/mspm0_sdk_2_04_00_06/.metadata/product.json" -d "MSPM0G110X" -p "VQFN-24(RGE)" -r "Default" --context "system" --compiler gcc
	@echo 'Finished building: "$<"'
	@echo ' '
